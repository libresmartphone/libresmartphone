 ...
 *
 * Author: Ael Gain <ael.gain@free.fr>
 * Author: dmitry pervushin <dimka@embeddedalley.com>
 *
 * Copyright 2014 LibreCalc.
...
static unsigned char nkbd_keycode[49] = {
    KEY_ESC,       KEY_F1,       KEY_F2,       KEY_F3,    KEY_F4,    KEY_F5,    KEY_BACKSPACE,
    KEY_TAB,       KEY_A,        KEY_B,        KEY_C,     KEY_D,     KEY_E,     KEY_F,
    KEY_G,         KEY_H,        KEY_I,        KEY_J,     KEY_MINUS, KEY_SLASH, KEY_X,
    KEY_K,         KEY_L,        KEY_M,        KEY_S,     KEY_1,     KEY_2,     KEY_3,
    KEY_EQUAL,     KEY_R,        KEY_O,        KEY_T,     KEY_4,     KEY_5,     KEY_6,
    KEY_LEFTSHIFT, KEY_LEFTCTRL, KEY_LEFTALT,  KEY_UP,    KEY_7,     KEY_8,     KEY_9,
    KEY_LEFTCTRL,  KEY_LEFTALT,  KEY_LEFT,     KEY_DOWN,  KEY_RIGHT, KEY_SPACE, KEY_ENTER, 
};
...
static void mxs_auart_rx_char(struct mxs_auart_port *s)
{
    ...
    if(c > -1 && c < 98)
    {
	    ...
	    // fait la transposee
	    c = (char)(c/7) + (c%7)*7;
//            key     = nkbd_keycode[48-c];
            key     = nkbd_keycode[c];
            pressed = 0;
        }
        else
        {
//            key     = nkbd_keycode[97-c];
	    c -= 49;
	    c = (char)(c/7) + (c%7)*7;
...
static int mxs_auart_probe(struct platform_device *pdev)
{
    ...
    input_dev->name = "Awesome libreCalc keyboard";
